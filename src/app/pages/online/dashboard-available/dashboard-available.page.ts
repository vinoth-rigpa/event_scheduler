...
@Component({
  ...
  templateUrl: './dashboard-available.page.html',
  styleUrls: ['./dashboard-available.page.scss'],
})
export class DashboardAvailablePage implements OnInit {
  device_uuid: any = '';
  device_password: any = '';
  roomName: string = '';
  ...
  constructor(
    ...
    AppConfig.consoleLog('Online DashboardAvailablePage constructor');
